...
function Head() {
  ...
  const currentTitle =
    asPath === '/'
      ...
      : `${title} — @neshca/cache-handler`;

  return (
    <>
      <meta content={url} property="og:url" />
      <meta
        content={frontMatter.title || '@neshca/cache-handler'}
        property="og:title"
      />
      <meta
        content={
          frontMatter.description || '@neshca/cache-handler documentation'
        }
...
export default {
  ...
  docsRepositoryBase:
    'https://github.com/caching-tools/next-shared-cache/tree/canary/docs/cache-handler-docs',
  head: Head,
  footer: {
    content: (
      <span>
